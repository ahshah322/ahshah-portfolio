      ...
      >
        <div className="w-full lgl:w-1/2">
          ...
          <div className="flex flex-col gap-6">
            <div className="overflow-x-hidden">
              ...
              <span className="w-full h-2 bgOpacity rounded-md inline-flex mt-2">
                <motion.span
                  ...
                  className="w-[90%] h-full bg-designColor rounded-md relative"
                >
            ...
            <div className="overflow-x-hidden">
              <p className="text-sm uppercase font-medium">.NET Core</p>
              <span className="w-full h-2 bgOpacity rounded-md inline-flex mt-2">
                <motion.span
                  initial={{ x: "-100%", opacity: 0 }}
                  animate={{ x: 0, opacity: 1 }}
            ...
            <div className="overflow-x-hidden">
              ...
              <span className="w-full h-2 bgOpacity rounded-md inline-flex mt-2">
                <motion.span
                  ...
                  className="w-full h-full bg-designColor rounded-md relative"
            ...
            <div className="overflow-x-hidden">
              ...
              <span className="w-full h-2 bgOpacity rounded-md inline-flex mt-2">
                <motion.span
                  ...
                  animate={{ x: 0, opacity: 1 }}
                  transition={{ duration: 0.5, delay: 0.5 }}
                  className="w-[95%] h-full bg-designColor rounded-md relative"
                >
            ...
            <div className="overflow-x-hidden">
              ...
              <span className="w-full h-2 bgOpacity rounded-md inline-flex mt-2">
                <motion.span
                  ...
                  animate={{ x: 0, opacity: 1 }}
                  transition={{ duration: 0.5, delay: 0.5 }}
                  className="w-[80%] h-full bg-designColor rounded-md relative"
                >
                  <span className="absolute -top-7 right-0">80%</span>
                </motion.span>
              </span>
            ...
            <div className="overflow-x-hidden">
              ...
              <span className="w-full h-2 bgOpacity rounded-md inline-flex mt-2">
                <motion.span
                  ...
                  animate={{ x: 0, opacity: 1 }}
                  transition={{ duration: 0.5, delay: 0.5 }}
                  className="w-[75%] h-full bg-designColor rounded-md relative"
                >
                  <span className="absolute -top-7 right-0">75%</span>
                </motion.span>
              </span>
            ...
            <div className="overflow-x-hidden">
              ...
              <span className="w-full h-2 bgOpacity rounded-md inline-flex mt-2">
                <motion.span
                  ...
                  animate={{ x: 0, opacity: 1 }}
                  transition={{ duration: 0.5, delay: 0.5 }}
                  className="w-[60%] h-full bg-designColor rounded-md relative"
                >
            ...
            <div className="overflow-x-hidden">
              ...
              <span className="w-full h-2 bgOpacity rounded-md inline-flex mt-2">
                <motion.span
                  ...
                  animate={{ x: 0, opacity: 1 }}
                  transition={{ duration: 0.5, delay: 0.5 }}
                  className="w-[70%] h-full bg-designColor rounded-md relative"
                >
